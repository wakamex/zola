...
use utils::site::{WikilinkError, resolve_internal_link};
...
mod tests {
    ...
    #[test]
    fn reports_ambiguous_wikilink_candidates() {
        ...
        let message = render_content("[[duplicate]]", &context).unwrap_err().to_string();
